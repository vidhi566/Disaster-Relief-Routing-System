...
ProblemData readInputData(const string& filename) {
    ...
    data.wDry = data.packages[0].weight;
    data.vDry = data.packages[0].value;
    data.wPer = data.packages[1].weight;
    data.vPer = data.packages[1].value;
    data.wOther = data.packages[2].weight;
    data.vOther = data.packages[2].value;
